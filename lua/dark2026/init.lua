...
function M.load(opts)
  ...
  hl('DiagnosticVirtualTextError', { fg = p.err, bg = bg })
  hl('DiagnosticVirtualTextWarn',  { fg = p.warn, bg = bg })
  hl('DiagnosticVirtualTextInfo',  { fg = p.info, bg = bg })
  hl('DiagnosticVirtualTextHint',  { fg = p.hint, bg = bg })
